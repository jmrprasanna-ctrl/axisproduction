...
const UiSetting = db.define(
  "UiSetting",
  {
    ...
    primary_color: { type: DataTypes.STRING(24), allowNull: false, defaultValue: "#4f8fb8" },
    accent_color: { type: DataTypes.STRING(24), allowNull: false, defaultValue: "#8fc7ad" },
    background_color: { type: DataTypes.STRING(24), allowNull: false, defaultValue: "#eef1f3" },
    button_color: { type: DataTypes.STRING(24), allowNull: false, defaultValue: "#4f8fb8" },
