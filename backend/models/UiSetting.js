...
const UiSetting = db.define(
  "UiSetting",
  {
    ...
    primary_color: { type: DataTypes.STRING(24), allowNull: false, defaultValue: "#4b8fbd" },
    accent_color: { type: DataTypes.STRING(24), allowNull: false, defaultValue: "#58ae86" },
    background_color: { type: DataTypes.STRING(24), allowNull: false, defaultValue: "#eaf2f7" },
    button_color: { type: DataTypes.STRING(24), allowNull: false, defaultValue: "#4b8fbd" },
