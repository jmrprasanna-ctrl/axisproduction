...
const ACCESS_MODULE_OPTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/dashboard/tiles/total-vendors", label: "Tile: Total Vendors", actions: ["view"] },
      { path: "/dashboard/tiles/total-products", label: "Tile: Total Products", actions: ["view"] },
      { path: "/dashboard/tiles/total-sales", label: "Tile: Total Sales", actions: ["view"] },
      { path: "/dashboard/tiles/received-payment", label: "Tile: Recieved Payment", actions: ["view"] },
      { path: "/dashboard/tiles/rental-machines-counts", label: "Tile: Rental Machines Counts", actions: ["view"] },
      { path: "/dashboard/tiles/rental-consumables", label: "Tile: Rental Consumables", actions: ["view"] },
      { path: "/dashboard/tiles/total-expenses", label: "Tile: Total Expenses", actions: ["view"] },
      { path: "/dashboard/tiles/support-technician-pay", label: "Tile: Support Technician Pay (on Balance)", actions: ["view"] },
      { path: "/dashboard/tiles/vendor-paid", label: "Tile: Vender Paid", actions: ["view"] },
      { path: "/dashboard/tiles/net-profit", label: "Tile: Net Profit", actions: ["view"] },
