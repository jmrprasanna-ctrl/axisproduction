(function () {
    ...
    async function loadBackupConfig() {
        ...
        driveRootFolderEl.value = String(settings.drive_root_folder_name || "AXIS PRODUCTION");
    ...
    async function saveBackupConfig() {
        ...
        const payload = {
            ...
            drive_root_folder_name: String(driveRootFolderEl.value || "").trim() || "AXIS PRODUCTION",
        };
    ...
    async function testDrive() {
        ...
        try {
            ...
            const root = res?.result?.folder_path || res?.result?.root_folder_name || "AXIS PRODUCTION";
