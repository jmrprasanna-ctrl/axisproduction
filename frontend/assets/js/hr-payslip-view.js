...
function renderPayslip(response) {
  ...
  document.getElementById("pvCompanyName").textContent = toSafeText(company.company_name, "AXIS PRODUCTION");
...
function buildPayslipPdfDoc() {
  ...
  doc.setFontSize(18);
  doc.text(String(company.company_name || "AXIS PRODUCTION"), left, y);
  y += 16;
